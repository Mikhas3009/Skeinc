...
UserSaveBtn.addEventListener('click', ()=>{
    ...
    let userAddress = UserDataFields[3];
    let userPost = UserDataFields[4];
    let userCartAddress = document.querySelector('.profile-cart-user-address');
    let userCartPost = document.querySelector('.profile-cart-user-post');

    userCartAddress.children[0].innerHTML = userAddress.value;
    userCartPost.children[0].innerHTML = userPost.value;
